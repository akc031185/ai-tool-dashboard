    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-6 md:p-8">
          <h1 className="text-2xl md:text-3xl mb-6 text-gray-800 text-center font-bold">🚀 Submit AI Tool Request</h1>
          
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Tool Information Section */}
            <div className="border-b pb-6">
              <h2 className="text-lg md:text-xl font-semibold text-gray-700 mb-4">Tool Information</h2>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-colors"
                  required
                />
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg mb-4">
                <h3 className="text-base md:text-lg font-medium text-gray-700 mb-3">🤖 AI-Powered Description Generator</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-2 mb-3">
                  ...
                  <button
                    ...
                    disabled={aiLoading}
                    className="w-full sm:w-auto bg-blue-500 text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {aiLoading ? '🤖...' : '✨ Generate'}
                  </button>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-3 border border-gray-300 rounded-lg h-32 md:h-40 resize-none focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-colors"
                  required
                />
              </div>
            </div>
            ...
            <div>
              <h2 className="text-lg md:text-xl font-semibold text-gray-700 mb-4">Contact Information</h2>
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-4 rounded-lg font-semibold text-lg hover:from-pink-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
              {loading ? (
